...
for i = 1:length(Structures)
  ...
  set(10*i+1, 'Name', sprintf('Rob%d_Hist', i), 'NumberTitle', 'off','units','normalized','outerposition',[0 0 1 1]);
...
%   ylabel('Häufigkeit (abs)');
  ...
  if Structures{i}.Type == 0 % Seriell
    s_anim = struct( 'gif_name', fullfile(resmaindir, sprintf('Rob%d_%s_Animation.gif', i, Name)));
