...
if any(dist_exc_tot(:) < 0)
  ...
  debug_plot_robot(R, zeros(R.NJ,1), Traj_0, Traj_W, Structure, p, fval);
  return
end
% basediam = 0;
...
if any(I_ZBviol)
  ...
  debug_plot_robot(R, Q(1,:)', Traj_0, Traj_W, Structure, p, fval);
  return
end
...
function debug_plot_robot(R, q, Traj_0, Traj_W, Structure, p, fval)
