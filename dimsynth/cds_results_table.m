...
ResTab  = cell2table(cell(0,37), 'VariableNames', {'LfdNr', 'Name', 'Typ', ...
  ...
  'Gelenkbereich_phys', 'KinLaenge_fval', 'KinLaenge_phys', ...
...
Descr_Row = {'', '', '', '', '', '', '', 'Zielfunktion der Optimierung', '', ...
  ...
  '(normiert)', 'in µm', '(normiert)', 'in Grad', '(normiert)', 'in mm', ...
