...
vn = {'LfdNr', 'Name', 'Typ', ...
  ...
  'MRK1_fval', 'MRK1_physval', 'MRK2_fval', 'MRK2_physval', 'MRK3_fval', 'MRK3_physval', ... % MRK-Kennzahlen
...
Descr_Row = {'', '', '', '', '', '', '', 'Zielfunktion der Optimierung', '', ...
  ...
  '(normiert)', '(phys.)', '(normiert)', '(phys.)', '(normiert)', '(phys.)', ... % MRK-Kennzahlen
...
for i = 1:length(Structures)
  ...
  elseif f <= 5e6, fval_text = 'MRK-NB (Klemmabstand)';
