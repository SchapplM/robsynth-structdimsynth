...
ResTab  = cell2table(cell(0,39), 'VariableNames', {'LfdNr', 'Name', 'Typ', ...
  ...
  'Bauraum_fval', 'Bauraum_phys', 'Nachgiebigk_fval', 'Nachgiebigk_phys', ...
...
Descr_Row = {'', '', '', '', '', '', '', 'Zielfunktion der Optimierung', '', ...
  ...
  '(normiert)', 'in m³','transl., normiert',  'in mm/N',  'in N/mm', ...
