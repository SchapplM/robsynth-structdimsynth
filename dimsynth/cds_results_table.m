...
ResTab  = cell2table(cell(0,29), 'VariableNames', {'LfdNr', 'Name', 'Typ', ...
...
for i = 1:length(Structures)
  ...
  elseif f < 1e4*2e5, fval_text = 'AR-Hindernis Eckpkt.';
  ...
  % aussagekräftig)
  Row_i = [Row_i, {1/tmp.RobotOptRes.physval_obj_all(8)}]; %#ok<AGROW>
