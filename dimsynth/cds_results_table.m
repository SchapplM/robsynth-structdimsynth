...
ResTab  = cell2table(cell(0,41), 'VariableNames', {'LfdNr', 'Name', 'Typ', ...
  ...
  'Gelenkbereich_phys', 'AntrGeschw_fval', 'AntrGeschw_phys', 'KinLaenge_fval', 'KinLaenge_phys', ...
  'Bauraum_fval', 'Bauraum_phys', 'Footprint_fval', 'Footprint_phys', 'Nachgiebigk_fval', 'Nachgiebigk_phys', ...
...
Descr_Row = {'', '', '', '', '', '', '', 'Zielfunktion der Optimierung', '', ...
  ...
  'in rad/s bzw. m/s', '(normiert)', 'in mm', ...
  '(normiert)', 'in m³','(normiert)', 'in m²','transl., normiert',  'in mm/N',  'in N/mm', ...
...
for i = 1:length(Structures)
  ...
  elseif f <= 1e4*9e5, fval_text = 'Gel.-Pos.-Grenze Eckpkt.';
