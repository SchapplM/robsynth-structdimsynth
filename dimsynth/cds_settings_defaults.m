...
general = struct( ...
  ...
  'animation_clean', false, ... % Übersichtlichere Animation ohne Beschriftungen (KS, Titel), Achsen oder Gitterlinien
  ...
  'eval_figures', {{'histogram', 'fitness_various', 'jointtraj', ... % Liste der zu erstellenden Bilder. ...
    'robvisuanim', 'pareto_all_phys_groups', 'pareto_all_phys', 'pareto'}}, ... % ... Auswahl, siehe cds_vis_results.m
...
optimization = struct( ...
  'objective', {{'TODO'}}, ... % Zielfunktion. Möglich: mass, energy, power, condition, 
   ...
   ... % installspace, footprint, colldist, mrk1, mrk2. Auch mehrere gleichzeitig möglich.
  ...
  'constraint_obj', zeros(length(defstruct.objconstr_names_all),1), ... % Nebenbedingungen, 1=Mass, 2=Energy, 3=Actforce, 4=Condition, 5=Stiffness, 6=MaterialStress, 7=PositionError, 8=MRK1, 9=MRK2; Eintrag entspricht physikalischem Wert
