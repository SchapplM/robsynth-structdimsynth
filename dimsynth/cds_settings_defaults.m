...
optimization = struct( ...
  'objective', {'energy'}, ... % Zielfunktion. Möglich: mass, energy, condition, valid_kin, valid_act, actforce, stiffness, jointrange, manipulability, minjacsingval; auch mehrere gleichzeitig möglich.
