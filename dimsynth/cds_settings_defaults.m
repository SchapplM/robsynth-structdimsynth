...
optimization = struct( ...
  ...
  'objective_ik', {{'default'}}, ... % Zielgröße für IK bei Redundanz. Möglich: default (Einstellung anhand der Kriterien der Maßsynthese), ikjac_cond, jac_cond, none (keine Optimierung, nur geringste Beschleunigung)
