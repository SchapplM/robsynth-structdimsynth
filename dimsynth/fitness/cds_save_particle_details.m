...
function PSO_Detail_Data_output = cds_save_particle_details(Set, comptime, fval, option)
...
if isempty(PSO_Detail_Data) || strcmp(option, 'reset')
  PSO_Detail_Data = struct('comptime', NaN(size_data), 'fval', NaN(size_data));
