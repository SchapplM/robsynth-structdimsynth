...
defstruct.objconstr_names_all = {'mass', 'energy', 'actforce', 'condition', ...
  'stiffness', 'materialstress', 'positionerror', 'mrk1', 'mrk2', 'mrk3', 'mrk4'};
...
defstruct.obj_names_all = {'mass', 'energy', 'power', 'actforce', 'materialstress', 'condition', ...
  ...
  'actvelo','chainlength', 'installspace', 'footprint', 'colldist', 'mrk1', 'mrk2', 'mrk3', 'mrk4', 'stiffness'}; % konsistent zu fval_obj_all und physval_obj_all
